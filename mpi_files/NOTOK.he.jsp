...
<%@ include file="/merchantPages/WebSources/includes/error.jsp" %>
...
<div id="main">
	...
	<div class="sep"></div>
	<div id="page_desc">
		קוד שגיאה: <strong><span dir="ltr"><%=v_error_code%></span></strong>
		<br />
		הודעת שגיאה: <strong><%=v_error_text%></strong>
		<br />
		מספר טראנזקציה: <strong><%=v_error_tid%></strong>
	</div>
</div>
<br />
