...
<div class="grid_12" width="100%">
	<div class="grid_12 row1 logo"><img src="merchantPages/afrodita/images/afroditalogo.jpg" width="197" height="68" /></div>
</div>
...
<form id="creditForm" onsubmit="return validateFormTrack2CardNo();" method="POST" action="ProcessCreditCard">
	...
	<div class="grid_12 rowPayments" style="display:<%=showPaymentsInterest%>">
		...
		<div id="form_buttons" class="grid_12 row13 td_style_fieldValue form_buttons">
			<input id="resetBtn" class="resetBtn" type="reset" value="<%=formReset%>" onclick="clearFields()" disabled />
...
<div class="grid_12 row14 pci-images-wrapper" height="100%" style="max-height: 3em;">
	<img class="row14 pci_image" src="merchantPages/afrodita/images/gotrust.jpg" alt="gotrust logo" title="gotrust logo"/>
	<img class="row14 pci_image" src="merchantPages/afrodita/images/MaterCard.jpg" alt="master card logo" title="master card logo"/>
	<img class="row14 pci_image" src="merchantPages/afrodita/images/Visa.jpg" alt="visa logo" title="visa logo"/>
	<img class="row14 pci_image" src="merchantPages/afrodita/images/Pci.jpg" alt="pci logo" title="pci logo"/>
