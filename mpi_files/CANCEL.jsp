...
<%@ include file="/merchantPages/WebSources/includes/cancel.jsp" %>
...
<%=engCSS%>
<title><%=cancel_title%></title>
</head>
<body>
<!--  DISPLAY TRANSACTION OK INFORMATION -->
<div id="main_frame" align="center">
<div id="main">
	<div id="page_title"><img id="ssl_logo" src="/CGMPI_Server/merchantPages/WebSources/images/ssl.png" alt="" title=""/><h1><%=cancel_title%></h1></div>
	<div id="logo"><img src="/CGMPI_Server/merchantPages/WebSources/images/logo_b.png" alt="" title=""/></div>
	<div class="sep"></div>
	<div id="page_desc">
		<%=ok_tid%>: <strong><%=txId%></strong>
	</div>
</div>
<br/>
